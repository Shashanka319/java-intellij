class Conditioner {
    ...
    Conditioner(int id, String brand, String productName, String hairType, String primaryIngredient, 
                double volumeMl, double price, boolean isLeaveIn, boolean isCrueltyFree, 
                String fragrance, String color, float phLevel, int shelfLifeMonths, 
                String targetConcern, boolean isParabenFree, String containerType, 
    ...
    void display() {
        ...
        System.out.println("Main Ingredient: " + this.primaryIngredient);
        System.out.println("Volume: " + this.volumeMl );
        System.out.println("Price: $" + this.price);
        System.out.println("Leave-In: " + this.isLeaveIn);
        ...
        System.out.println("Paraben-Free: " + this.isParabenFree);
